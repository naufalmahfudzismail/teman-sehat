...
import kotlinx.android.synthetic.main.adapter_kit_posyandu.view.*

class KitAdapter(val context: Context, var data: List<Kit>, val onItemClick : (Kit) -> Unit) :
    RecyclerView.Adapter<KitAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = parent.inflate(R.layout.adapter_kit_posyandu)
